...
//The deleteNode function searches for a node with num as its value. The node, if found deleted from the list and from memory.
void LinkedList::deleteNode(double num)
{
    // To traverse the list & point to the previous node
	ListNode *nodePtr;       
